...
3.0.3.dev201711191648
---------------------

New
~~~
- --author-format (name and/or email) and --omit-author (for pruning
  names) [Travis Shirk]

Other
~~~~~
- Merge branch 'normal_setup' into nicfit.py. [Travis Shirk]

  * normal_setup:
    Pre-run autogen
- Pre-run autogen. [Travis Shirk]
